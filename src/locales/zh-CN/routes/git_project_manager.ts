export default {
  ...
  // 周报页面
  weekly_report_title: '周报生成',
  weekly_report_description: '选择项目和时间范围，基于 PR 记录生成智能周报',
  back: '返回',
  report_configuration: '报告配置',
  select_repositories_first: '请先选择项目',
  select_time_range_first: '请选择时间范围',
  loading_repositories: '加载项目中...',
  no_repositories_available: '暂无可用项目',
  search_prs: '搜索 PR',
  searching: '搜索中...',
  pr_list: 'PR 列表',
  no_prs_found: '未找到 PR 记录',
  prs_loaded: '已加载 {{count}} 条 PR 记录',
  weekly_report: '周报内容',
  select_prs_to_generate: '请选择 PR 后生成报告',
  click_generate_report: '点击生成报告按钮开始',
