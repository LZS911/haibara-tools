export default {
  ...
  downloaded_at: '下载于',
  delete_history_record: '删除记录',
  delete_history_record_success: '删除成功',
  delete_history_record_failed: '删除失败',
  no_download_history: '暂无下载历史',
  clear_history: '清空历史',
  confirm_delete_record: '确认删除此记录？',
  confirm_clear_history: '确认清空所有历史记录？',
  total_records: '共 {{count}} 条记录',

  // Settings - Bilibili
  settings_bilibili_section: 'Bilibili 下载配置',
  settings_bilibili_title: '视频下载服务',
  settings_bilibili_desc: '配置 Bilibili 账号信息和下载路径',
  settings_bilibili_sessdata_placeholder: '输入 SESSDATA Cookie',
  settings_bilibili_sessdata_tip: '登录后可下载更高清晰度的视频',
  settings_bilibili_bfe_id_placeholder: '输入 BFE_ID Cookie',
  settings_bilibili_download_path: '下载路径',
  settings_bilibili_download_path_placeholder: '选择视频下载保存路径',
  settings_select_folder: '选择文件夹',
  settings_tab_llm: 'LLM 配置',
  settings_tab_media_to_docs: '视频转文档',
  settings_tab_bilibili: 'Bilibili 下载',
