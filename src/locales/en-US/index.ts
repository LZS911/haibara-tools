export default {
  ...
  nav_bilibili_downloader: 'Bilibili',
  ...
  delete_history_record: 'Delete Record',
  ...
  confirm_delete_record: 'Confirm to delete this record?',
  confirm_clear_history: 'Confirm to clear all history?',
  total_records: 'Total {{count}} records',

  // Settings - Bilibili
  settings_bilibili_section: 'Bilibili Download Configuration',
  settings_bilibili_title: 'Video Download Service',
  settings_bilibili_desc:
    'Configure Bilibili account information and download path',
  settings_bilibili_sessdata_placeholder: 'Enter SESSDATA Cookie',
  settings_bilibili_sessdata_tip: 'Login to download higher quality videos',
  settings_bilibili_bfe_id_placeholder: 'Enter BFE_ID Cookie',
  settings_bilibili_download_path: 'Download Path',
  settings_bilibili_download_path_placeholder:
    'Select video download save path',
  settings_select_folder: 'Select Folder',
  settings_tab_llm: 'LLM Configuration',
  settings_tab_media_to_docs: 'Media to Docs',
  settings_tab_bilibili: 'Bilibili Download',
